...
const ToastAction = React.forwardRef<React.ElementRef<typeof Button>, React.ComponentPropsWithoutRef<typeof Button>>(
  ({ className, ...props }, ref) => {
    return <Button ref={ref} variant="outline" size="sm" className={cn("ml-auto mb-0", className)} {...props} />
  },
)
